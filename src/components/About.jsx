    ...
    return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="w-full md:w-1/3 flex justify-center md:justify-start">
          <img src={foto} alt="foto" className="w-45 h-40 rounded-lg shadow-lg" />
        </div>
        <div className="w-full md:w-2/3 text-center md:text-left">
          ...
          <a href='../../public/cv.pdf' download className="btn btn-secondary">Descargar CV</a>
          <button className="btn btn-secondary">Ver Proyectos</button>
          </div>
        </div>
        </div>
      </div>
